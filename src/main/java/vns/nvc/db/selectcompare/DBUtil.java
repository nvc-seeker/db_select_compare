...
public class DBUtil {
    ...
    static {
        try {
            ...
            properties.load(new FileInputStream(Paths.get("").toAbsolutePath() + "/output/db.properties"));
        ...
        } catch (ClassNotFoundException | IOException | SQLException | InstantiationException
